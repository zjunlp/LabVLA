...
class TrainACTImageWorkspaceLightning(LightningWorkspace):
    """
    ACT training workspace based on PyTorch Lightning
...
@hydra.main(
    ...
    config_name="train_act_image_workspace")
def main(cfg):
    # Create workspace
    workspace = TrainACTImageWorkspaceLightning(cfg)
